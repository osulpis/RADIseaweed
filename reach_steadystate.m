...
stoptime = 1000;       %[a] total timespan of the problem
interval=1/60000;          %[a] time resolution (1/60000 is nine minutes, 1/8760 is one hour; 1/365.2 is a day)
...
Foc_s=0; %[mol/m2/a] flux of total organic carbon to the bottom 
...
b = 0;%stoptime; % end organic carbon flux in years
t_start = a / interval;
t_end = b / interval; 
